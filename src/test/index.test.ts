...
import { AccountManager, AccountWallet, CompleteAddress, ContractDeployer, createAztecNodeClient, Fr, PXE, waitForPXE, TxStatus, createPXEClient, getContractInstanceFromDeployParams, Logger, createLogger } from "@aztec/aztec.js";
...
const tempDir = path.join('./pxe');

const setupPXE = async () => {
    const { SANDBOX_URL = 'http://localhost:8080' } = process.env;
    const aztecNode = createAztecNodeClient(SANDBOX_URL);
